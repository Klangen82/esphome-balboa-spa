...
static const float   ESPHOME_BALBOASPA_POLLING_INTERVAL = 50; // ms
...
class BalboaSpa : public uart::UARTDevice, public PollingComponent {
 public:
  ...
  InternalGPIOPin *direction_pin_{nullptr};
 ...
 private:
  ...
  char config_request_status = 0;
  char faultlog_request_status = 0;
  char filtersettings_request_status = 0;
  char faultlog_update_timer = 0;
  char filtersettings_update_timer = 0;
